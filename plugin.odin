...
// Plugin descriptor containing metadata about the plugin
...
Plugin_Factory :: struct {
	...
	// Create a plugin instance by plugin ID
...
Plugin :: struct {
	desc:             ^Plugin_Descriptor, // Plugin descriptor
	...
	activate:         proc "c" (
		plugin: ^Plugin,
		sample_rate: f64,
		min_frames_count, max_frames_count: u32,
	) -> bool,
	// [main-thread & active]
